...
//use Mageplaza\SocialLogin\Model\Instagram\CustomerFactory as InstagramModelFactory;
use Mageplaza\SocialLogin\Model\ResourceModel\Instagram\CollectionFactory as InstagramCollectionFactory;
use Mageplaza\SocialLogin\Model\ResourceModel\Twitter\CollectionFactory as TwitterCollectionFactory;
//use Mageplaza\SocialLogin\Model\Twitter\CustomerFactory as TwitterModelFactory;
...
class CheckUserEditObserver implements ObserverInterface
{
    ...
    public function execute(\Magento\Framework\Event\Observer $observer)
    {
        ...
        if (!count($isError) && $customer !== null) {
            ...
            if ($instagram!=null && $this->helperInstagram->sendPassword()=='1' && strpos($customer->getEmail(), '@instagram.com')!==false && $instagram->getData('is_send_password_email')=='0') {
            ...
            } elseif ($twitter!=null && $this->twitterHelper->sendPassword()=='1' && strpos($customer->getEmail(), '@twitter.com')!==false && $twitter->getData('is_send_password_email')=='0') {
                $customer->sendPasswordReminderEmail();
    ...
    {
        $instagram = $this->instagramCustomerCollectionFactory->create();
    ...
    {
        $twitter = $this->twitterCustomerCollectionFactory->create();
