...
use Mageplaza\SocialLogin\Hybrid\AmazonOAuth2Client;
 ...
 */
class Amazon extends ProviderModelOAuth2
{
    ...
    function initialize()
    {
        ...
        require_once Auth::$config['path_libraries'] . 'Amazon/AmazonOAuth2Client.php';

        // create a new OAuth2 client instance
        $this->api = new AmazonOAuth2Client($this->config['keys']['id'], $this->config['keys']['secret'],
            $this->endpoint, $this->compressed);
