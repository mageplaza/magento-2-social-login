...
class Vkontakte extends Hybrid_Provider_Model_OAuth2
{
    ...
    function loginFinish()
    {
        ...
        Hybrid_Auth::storage()->set("hauth_session.{$this->providerId}.user_email",
    ...
    function getUserProfile()
    {
        ...
        if (isset($response->error)) {
            throw new \RuntimeException("User profile request failed! {$this->providerId} returned an error #{$response->error->error_code}: {$response->error->error_msg}",
                6);
        }
