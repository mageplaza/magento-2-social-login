...
class OpenIDConnectClient
{
     ...
     *
     */
    public function __construct($provider_url = null, $client_id = null, $client_secret = null,$redirectUrlLive = null) {
        $this->setProviderURL($provider_url);
        $this->clientID = $client_id;
        $this->clientSecret = $client_secret;
        $this->redirectUrlLive = $redirectUrlLive;
    }

    public function getRedirectUrlLive(){
        return $this->redirectUrlLive;
    ...
    private function requestAuthorization() {
        ...
        $auth_endpoint .= '?' . http_build_query($auth_params, null, '&').'&scope=openid+profile';
        session_commit();
